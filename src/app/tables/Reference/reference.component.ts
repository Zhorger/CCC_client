...
export class ReferenceComponent extends AppComponent {
  ...
  onGridReady(params): void {
    ...
    const datasource = {
      getRows: params => {
        ...
        this.olympicWinnersService.getDish(JSON.stringify({ ...params.request })).subscribe(response => params.success({
